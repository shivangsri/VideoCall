This App uses FireBase to authenticate user and it has login and signup page. Once user login then he is directed to call screen. For calling i have used Jisit Meet Handbook SDK.
